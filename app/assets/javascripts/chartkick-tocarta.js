...
(function() {
  ...
  function jsOptionsFunc(defaultOptions, hideLegend, setMin, setMax, setHighChart) {
  ...
  if ("Highcharts" in window) {
    ...
    var jsOptions = jsOptionsFunc(defaultOptions, hideLegend, setMin, setMax, setHighChart);
