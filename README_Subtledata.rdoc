...
client = Subtledata::Client.new(sd_settings)
...
Authenticate User
Request: c.get("0111",["tocarta","tocarta123","0","0","1269"]).body
Response: "0111|1639|1270|cfc9bdb5-4dfb-43d3-8fa7-83d5d6d11226"

Set their GPS location
Request: c.get("0105",["1639","41.1167","1.2500"]).body
Response: "0105|1"
