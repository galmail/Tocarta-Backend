    ...
    config: {
      ...
      views: [
	    ...
	    refs: {
	    	...
	    	beveragesButton: 'top-toolbar segmentedbutton #tcBeveragesMenuBtnId',
	    	dessertsButton: 'top-toolbar segmentedbutton #tcDessertsMenuBtnId',
	    	
	    	winesButton: 'top-toolbar segmentedbutton #tcWinesMenuBtnId',
	    	cocktailsButton: 'top-toolbar segmentedbutton #tcCocktailsMenuBtnId',
