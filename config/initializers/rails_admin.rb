...
RailsAdmin.config do |config|
  ...
  config.actions do
    ...
    import do
      visible do
        ["Restaurant","Waiter","Resource","Payment","Discount","Printer","Floor","Table","Menu","Section","Subsection","Dish"].include?(bindings[:abstract_model].model.to_s)
      end
    end
...
RailsAdminImport.config do |config|
  ...
  config.model Table do
    excluded_fields do
      [
       :name, :status, :dinners, :dinners, :sid, :language,
       :tablet, :order, :restaurant_activity
      ]
    end
    label :name
  end
